...
public class ItemPedido implements Serializable {
	...
	/* Como ItemPedidoPK é uma classe anormal para fazer o mapeamento dos ids de produto e pedido,
	 * ao invés de constructor chamar ItemPedidoPK, ele chamou o ID do ItemPedidoPK e colocou o ID do pedido e do produto 
	 * */
